...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description=(
            "Convert Markdown files to .docx. By default converts files listed in DELIVERABLES."
        )
    )
    parser.add_argument(
        "files",
    ...
    parser.add_argument(
        ...
        "-a",
        action="store_true",
        help="Convert all .md files under the repository root",
    )
    parser.add_argument(
        "--out",
        "-o",
        help=(
            "Output directory for generated .docx files (relative to repo root). "
